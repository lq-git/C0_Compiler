...
extern void situation_list(char label[], char for_compare[]);
extern void case_state(char label[], char for_compare[]);
...
extern int get_type_by_name(char name[], int kind);
